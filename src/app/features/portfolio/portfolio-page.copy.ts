...
export const PORTFOLIO_PAGE_COPY: Record<PortfolioLocale, PageCopy> = {
  en: {
    ...
    work: {
      ...
      flagships: [
        {
          kicker: 'Betclic Group · Since 2026',
        ...
        {
          kicker: 'TF1 Group · 2022–2026 · Tech Lead of two teams',
          title: 'Modernizing a broadcaster’s ad platform without stopping it',
          summary:
            'Leading the redesign of TF1’s advertising platform from 2022 to 2026: 11 projects shipped to production, a VB6-era stack retired step by step, and two teams that got stronger along the way.',
          path: '/work/tf1',
        },
      ],
      compact: [
  ...
  fr: {
    ...
    work: {
      ...
      flagships: [
        {
          kicker: 'Betclic Group · Depuis 2026',
        ...
        {
          kicker: 'Groupe TF1 · 2022–2026 · Tech Lead de deux équipes',
          title: 'Moderniser le SI publicitaire d’un diffuseur sans l’arrêter',
          summary:
            'Piloter la refonte du SI publicitaire de TF1 de 2022 à 2026 : 11 projets mis en production, un legacy VB6 remplacé pas à pas, et deux équipes qui en sont sorties plus fortes.',
          path: '/fr/work/tf1',
        },
      ],
      compact: [
